...
public class ConstVarClassDeclList_Class extends ConstVarClassDeclList {

    private ConstVarClassDeclList ConstVarClassDeclList;
    private ClassDecl ClassDecl;

    public ConstVarClassDeclList_Class (ConstVarClassDeclList ConstVarClassDeclList, ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstVarClassDeclList_Class(\n");
